...
exports.createWallet = async(uniqueIdentifier) => {
    ...
    try {  
        ...
        let accountKey = (await kdm_client.exportKey(wallethandle, wallet_password, account.address)).private_key;
        ...
        const trust_token_asset_id =  parseInt(process.env.TRUST_TOKEN_RESERVE_ASSETID)
        const backer_token_asset_id =  parseInt(process.env.BACKER_TOKEN_RESERVE_ASSETID)
